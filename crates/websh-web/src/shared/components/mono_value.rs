...
use crate::platform::breakpoints::{BP_LG, BP_SM, use_min_width};

stylance::import_crate_style!(css, "src/shared/components/mono_value.module.css");
...
mod tests {
    ...
    fn middle_ellipsis_cases() {
        let cases = [
            ...
            ("0x1234", 6, 4, "0x1234"),
            ("abcdef12345", 6, 4, "abcdef12345"),
            ("한글한글한글한글한글한글", 2, 2, "한글…한글"),
        ];
