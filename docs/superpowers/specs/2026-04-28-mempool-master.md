...
After Phase 7, V1 is complete (Phases 4–7 are post-Phase-3 hardening + architectural pivot + UX consolidation + UX simplification — see Decision Log). V2 items (§7) are queued separately.
