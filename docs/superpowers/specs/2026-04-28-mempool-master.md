...
After Phase 8, V1 is complete (Phases 4–8 are post-Phase-3 hardening + architectural pivots + UX consolidations + design refinement — see Decision Log). V2 items (§7) are queued separately.
